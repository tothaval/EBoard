// <copyright file="DataLocations.cs" company="PlaceholderCompany">
...
public class DataLocations
{
    ...
    public static string EBoardFluidUIConfigurationsPath { get; } = @"FluidUIConfigurations\";

    public static string EBoardInstalledPluginsPath { get; } = @"Plugins\";

    public static string EBoardScreenDataPath { get; } = @"ScreenData\";
