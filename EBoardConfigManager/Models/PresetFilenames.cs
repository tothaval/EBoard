// <copyright file="PresetFilenames.cs" company="PlaceholderCompany">
...
public static class PresetFilenames
{
    ...
    public const string EBOARDLICENCEANDAABOUTFILENAME = "eboardLicenceAndAbout.json";
    public const string EBOARDMANUALFILENAME = "eboardManual.json";
}
