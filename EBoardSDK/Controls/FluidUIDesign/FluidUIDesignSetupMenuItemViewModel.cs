// <copyright file="FluidUIDesignSetupMenuItemViewModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
public partial class FluidUIDesignSetupMenuItemViewModel : ObservableObject, IFluidUIDesignSetup
{
    ...
    public FluidUIDesignSetupMenuItemViewModel(FluidUIBaseViewModel eboardFluidUIBaseViewModel)
    {
    ...
    {
        this.backgroundBrushSetupViewModel = new BrushSetupViewModel(this.ViewModel, Enums.BrushTargets.Background, this.SetBrushToBackground);

        this.foregroundBrushSetupViewModel = new BrushSetupViewModel(this.ViewModel, Enums.BrushTargets.Foreground, this.SetBrushToForeground);

        this.borderBrushSetupViewModel = new BrushSetupViewModel(this.ViewModel, Enums.BrushTargets.Border, this.SetBrushToBorder);

        this.highlightBrushSetupViewModel = new BrushSetupViewModel(this.ViewModel, Enums.BrushTargets.Highlight, this.SetBrushToHighlight);
        ...
        this.ChangeColorStringValue(this.BackgroundBS!, this.BackgroundBS?.Brush ?? FluidUIDesignDefaultPropertyFactory.BackgroundDefaultSolidColorBrush);
        this.ChangeColorStringValue(this.ForegroundBS!, this.ForegroundBS?.Brush ?? FluidUIDesignDefaultPropertyFactory.ForegroundDefaultSolidColorBrush);
        this.ChangeColorStringValue(this.BorderBS!, this.BorderBS?.Brush ?? FluidUIDesignDefaultPropertyFactory.BorderDefaultSolidColorBrush);
        this.ChangeColorStringValue(this.HighlightBS!, this.HighlightBS?.Brush ?? FluidUIDesignDefaultPropertyFactory.HighlightDefaultSolidColorBrush);
    }

    internal void ChangeColorStringValue(BrushSetupViewModel brushSetupViewModel, Brush brush)
    {
    ...
    private void SetBrushToBackground()
    {
        if (this.BackgroundBS?.Brush != null)
        {
            this.ApplyBrush(this.BackgroundBS!.Brush, BrushTargets.Background);
        }
    }

    private void SetBrushToForeground()
    {
        if (this.ForegroundBS?.Brush != null)
        {
            this.ApplyBrush(this.ForegroundBS!.Brush, BrushTargets.Foreground);
        }
    }

    private void SetBrushToBorder()
    {
        if (this.BorderBS?.Brush != null)
        {
            this.ApplyBrush(this.BorderBS!.Brush, BrushTargets.Border);
        }
    }

    private void SetBrushToHighlight()
    {
        if (this.HighlightBS?.Brush != null)
        {
            this.ApplyBrush(this.HighlightBS!.Brush, BrushTargets.Highlight);
        }
    }
}
