// <copyright file="FluidUIFontSetupMenuItemViewModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
public partial class FluidUIFontSetupMenuItemViewModel : ObservableObject, IFluidUIChangedAction
{
    private FluidUIBaseViewModel viewModel;

    private FluidUIFontSetupViewModel setupViewModel;

    /// <summary>
    /// Initializes a new instance of the <see cref="FluidUIFontSetupViewModel"/> class.
    /// </summary>
    /// <param name="eboardFluidUIBaseViewModel"></param>
    public FluidUIFontSetupMenuItemViewModel(FluidUIBaseViewModel eboardFluidUIBaseViewModel)
    {
        this.viewModel = eboardFluidUIBaseViewModel;
        this.setupViewModel = new FluidUIFontSetupViewModel(this.viewModel);
    ...
    public FluidUIFontSetupViewModel SetupViewModel => this.setupViewModel;
