// <copyright file="FluidUISelectionView.xaml.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
/// <summary>
/// Interaktionslogik für FluidUISelectionView.xaml.
/// </summary>
public partial class FluidUISelectionView : UserControl
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FluidUISelectionView"/> class.
    /// </summary>
    public FluidUISelectionView()
    {
    ...
    public static readonly DependencyProperty ConfirmationButtonContentProperty =
        DependencyProperty.Register("ConfirmationButtonContent", typeof(string), typeof(FluidUISelectionView), new PropertyMetadata("OK"));
