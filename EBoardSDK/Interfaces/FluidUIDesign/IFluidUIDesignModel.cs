...
/// FluidUI-Design logic and its properties.
/// </summary>
public interface IFluidUIDesignModel : IFluidUIChangedAction
{
    ...
    public FluidUIBrushModel BackgroundColor { get; set; }

    public FluidUIBrushModel BorderColor { get; set; }

    public FluidUIBrushModel ForegroundColor { get; set; }

    public FluidUIBrushModel HighlightColor { get; set; }

    public FluidUIBrushModel SelectionFallbackColor { get; set; }
