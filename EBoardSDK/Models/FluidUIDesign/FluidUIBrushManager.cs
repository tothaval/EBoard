...
public class FluidUIBrushManager : IFluidUIManager
{
    ...
    public async Task<Brush?> GetBrush()
    {
        ...
        switch (this.brushModel.BrushTypeEnum)
        {
            ...
            case Enums.BrushTypes.ImageBrush:
                Brush brush = FluidUIDesignDefaultPropertyFactory.GetImageBrush(this.brushModel.ImagePath);
    ...
    private void ProcessImageBrush(ImageBrush brush)
    {
        ...
        this.brushModel.ImagePath = ((BitmapImage)brush.ImageSource).UriSource.AbsoluteUri;
    ...
    private void ProcessLinearGradientBrush(LinearGradientBrush brush)
    {
        ...
        this.brushModel.GradientPoints.Add(brush.StartPoint);
        this.brushModel.GradientPoints.Add(brush.EndPoint);
    ...
    private void ProcessRadialGradientBrush(RadialGradientBrush brush)
    {
        ...
        this.brushModel.GradientPoints.Add(brush.Center);
        this.brushModel.GradientPoints.Add(brush.GradientOrigin);
    ...
    private void ProcessSolidColorBrush(SolidColorBrush brush)
    {
        ...
        this.brushModel.Color = brush.Color;
        this.brushModel.GradientColors.Add(brush.Color);
