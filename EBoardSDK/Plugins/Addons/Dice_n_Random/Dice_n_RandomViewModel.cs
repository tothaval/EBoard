// <copyright file="Dice_n_RandomViewModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
/// </p>
namespace EBoardSDK.Plugins.Addons.Dice_n_Random;
...
public partial class Dice_n_RandomViewModel : PluginBaseViewModel
{
    private readonly string pluginName = "Dice-n-Random";
    private readonly string pluginHeader = "Dice'n'Random";

    /// <summary>
    /// Initializes a new instance of the <see cref="Dice_n_RandomViewModel"/> class.
    /// </summary>
    public Dice_n_RandomViewModel()
    {
    ...
    /// <inheritdoc/>
    public override Type PluginViewModelType => typeof(Dice_n_RandomViewModel);
