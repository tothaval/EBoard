// <copyright file="CoordinatesModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
public class CoordinatesModel
{
    ...
    /// Initializes a new instance of the <see cref="CoordinatesModel"/> class.
    /// </summary>
    /// <param name="coordinatesViewModel">Desired is the instance that has to be stored.</param>
    public CoordinatesModel(CoordinatesViewModel coordinatesViewModel)
    {
        this.AxisLength = coordinatesViewModel.AxisLength;
    }

    public int AxisLength { get; set; } = 20;
}
