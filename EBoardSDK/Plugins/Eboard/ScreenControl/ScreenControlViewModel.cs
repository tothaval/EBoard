...
public partial class ScreenControlViewModel : EboardPluginBaseViewModel
{
    ...
    protected override void Setup()
    {
        ...
        {
            this.eBoardViewModel = this.MainViewModel.NavigationContextViewModel.EboardBrowserViewModel.SelectedEboard;
        ...
        if (this.EBoardViewModel != null)
        {
            ...
            this.fluidUISelectionViewModel = new FluidUISelectionViewModel(this.EBoardViewModel, null);
            this.pluginSelectionViewModel = new PluginSelectionViewModel(this.EBoardViewModel.FluidUI, null, singleSelectionTarget: false);

            // TODO neues uebergeordnetes ViewModel bauen fuer die ganzen ViewModels
            this.fluidUIDataBlockSetupViewModel = new FluidUIDataBlockSetupViewModel(this.EBoardViewModel, FluidUIStandSettings.ElementContextArea, templateCreation: true);
            this.fluidUIDesignSetupViewModel = new FluidUIDesignSetupViewModel(this.EBoardViewModel);
            this.fluidUIFontSetupViewModel = new FluidUIFontSetupViewModel(this.EBoardViewModel);
            this.fluidUISizeSetupViewModel = new FluidUISizeSetupViewModel(this.EBoardViewModel);
            this.fluidUIStandSetupViewModel = new FluidUIStandSetupViewModel(this.EBoardViewModel, FluidUIStandSettings.ElementContextArea, this.EBoardViewModel);
    ...
    {
        this.EBoardViewModel?.ClearSelectionTargets(this.SelectionTarget, titleString: this.TitleString, pluginName: this.SelectedPlugin?.Name);
    }
    ...
    {
        this.EBoardViewModel?.CopySelectedElements();
    }
    ...
    {
        this.EBoardViewModel?.DuplicateSelectedElements();
    }
    ...
    private void Move()
    {
        this.EBoardViewModel?.CopyMoveSelectedElements();
    }

    [RelayCommand]
    private void ApplyConfigurationOnSelected()
    {
        this.EBoardViewModel?.ApplyFluidUIConfigOnSelectedElements(this.FluidUISelectionViewModel);
    }

    [RelayCommand]
    private void LoadConfigurationOnSelected()
    {
        this.EBoardViewModel?.LoadFluidUIConfigOnSelectedElements(this.FluidUISelectionViewModel);
    }
    ...
    private void Paste()
    {
        this.EBoardViewModel?.PasteToScreen();
    }

    [RelayCommand]
    private void ResetConfigurationOnSelected()
    {
        this.EBoardViewModel?.ResetSelectedFluidUI(this.FluidUISelectionViewModel);
    }

    [RelayCommand]
    private void Select()
    {
        this.EBoardViewModel?.SelectSelectionTargets(
