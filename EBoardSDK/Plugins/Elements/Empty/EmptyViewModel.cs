// <copyright file="EmptyViewModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
/// </p>
namespace EBoardSDK.Plugins.Elements.Empty;
...
/// </summary>
public partial class EmptyViewModel : PluginBaseViewModel
{
    private readonly string pluginName = "Empty";
    private readonly string pluginHeader = "Empty";

    [ObservableProperty]
    private string content = "\t\t\t\n\n\n";

    /// <summary>
    /// Initializes a new instance of the <see cref="EmptyViewModel"/> class.
    /// </summary>
    ...
    /// <inheritdoc/>
    public override Type PluginViewModelType => typeof(EmptyViewModel);
