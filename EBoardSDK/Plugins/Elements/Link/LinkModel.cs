...
/// <summary>
/// Serializable data model for <see cref="LinkView"/>.
/// </summary>
public class LinkModel
{
    ...
    /// Initializes a new instance of the <see cref="LinkModel"/> class.
    /// </summary>
    /// <param name="linkViewModel">Desired is the instance that has to be stored.</param>
    public LinkModel(LinkViewModel linkViewModel)
    {
        this.ExtendedToolTip = linkViewModel.ExtendedToolTip;
