...
public partial class StandardTextFontSetupViewModel : ObservableObject
{
    ...
    private IFluidUIFontModel fluidUIFontModel;
    ...
    public StandardTextFontSetupViewModel(FluidUIBaseViewModel eboardFluidUIBaseViewModel, StandardTextViewModel standardTextViewModel, IFluidUIFontModel fluidUIFontModel)
    {
        this.viewModel = eboardFluidUIBaseViewModel;
        this.standardTextViewModel = standardTextViewModel;
        this.fluidUIFontModel = fluidUIFontModel;

        this.FontFamily = this.fluidUIFontModel.FontFamily;
        this.FontSizeValue = (int)this.fluidUIFontModel.FontSize;
        this.FontWeight = this.fluidUIFontModel.FontWeight;
...
[
    ...
    {
        this.fluidUIFontModel.FontSize = fontSize;
    ...
    public void ResetFont()
    {
        ...
        this.fluidUIFontModel.FontFamily = this.FontFamily;
        this.fluidUIFontModel.FontSize = this.FontSizeValue;
        this.fluidUIFontModel.FontWeight = this.FontWeight;
