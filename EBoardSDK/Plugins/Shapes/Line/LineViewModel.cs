// <copyright file="LineViewModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
public partial class LineViewModel : ShapeBaseViewModel
{
    private string pluginHeader = "Line Shape Element";

    private string pluginName = "Line";
