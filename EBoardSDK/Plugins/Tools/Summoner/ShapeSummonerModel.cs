// <copyright file="ShapeSummonerModel.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
internal class ShapeSummonerModel
{
    [JsonIgnore]
    private readonly ShapeSummonerViewModel shapeAreaViewModel;

    internal List<List<LinkModel>> Links { get; set; }

    /// <summary>
    /// Initializes a new instance of the <see cref="ShapeSummonerModel"/> class.
    /// </summary>
    internal ShapeSummonerModel()
    {
    }
    ...
    internal ShapeSummonerModel(ShapeSummonerViewModel shapeAreaViewModel)
    {
        this.shapeAreaViewModel = shapeAreaViewModel;
