...
public partial class UptimeViewModel : PluginBaseViewModel
{
    [ObservableProperty]
    private string clock = string.Empty;

    [ObservableProperty]
    private string uptime = string.Empty;
    ...
    /// <inheritdoc/>
    public override Type PluginViewModelType => typeof(UptimeViewModel);
