...
public class SharedMethod_UI
{
    ...
    public QuadValueSetupViewModel BuildQuadValueSetup(FluidUIBaseViewModel viewModel, Action action, BorderTargets borderTargets)
    {
    ...
    FluidUIBaseViewModel viewModel,
