// <copyright file="ResourceSet.cs" company=".">
// Stephan Kammel
// </copyright>
/// license
///
...
public class ResourceSet
{
    ...
    public Color C_Background { get; set; } = Colors.White;


    public Color C_Selection { get; set; } = Colors.DimGray;


    public Color C_Text { get; set; } = Colors.Black;


    public Color C_Expense { get; set; } = Colors.Red;


    public Color C_Gain { get; set; } = Colors.Green;


    public Color C_Text_Header { get; set; } = Colors.Orange;


    public CornerRadius ButtonCornerRadius { get; set; } = new CornerRadius(3);

    public CornerRadius VisibilityFieldCornerRadius { get; set; } = new CornerRadius(5);
    ...
    public bool ApplyBrushManagement(IFluidUIDesignModel brushManagement)
    {
        if (brushManagement == null)
        {
            return false;
        }

        Application.Current.Resources["BackgroundBrush"] = brushManagement.Background;
        Application.Current.Resources["TextBrush"] = brushManagement.Foreground;
        Application.Current.Resources["HeaderBrush"] = brushManagement.Highlight;
        Application.Current.Resources["SelectionBrush"] = brushManagement.Highlight;

        Application.Current.Resources["GainBrush"] = brushManagement.Foreground;
        Application.Current.Resources["ExpenseBrush"] = brushManagement.Border;
